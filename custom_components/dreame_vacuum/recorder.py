...
from .dreame import DreameVacuumAIProperty, DreameVacuumAutoSwitchProperty, DreameVacuumProperty
...
from .dreame.vacuum_types import (
    ATTR_ACTIVE_AREAS,
...
CAMERA_UNRECORDED_ATTRIBUTES = {
    ...
    ATTR_FRAME_ID,
    ATTR_COLOR_SCHEME,
    # Large map data attributes that can exceed 16KB limit
    ATTR_OBSTACLES,
    ATTR_FURNITURES,
    ATTR_VIRTUAL_WALLS,
    ATTR_WALL_LINES,
...
def exclude_attributes(hass: HomeAssistant) -> set[str]:
    ...
    return set(CAMERA_UNRECORDED_ATTRIBUTES) | set(VACUUM_UNRECORDED_ATTRIBUTES)
