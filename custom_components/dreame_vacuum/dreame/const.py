...
ERROR_LEFT_WHEEL_SPEED: Final = "left_wheel_speed"
ERROR_RIGHT_WHEEL_SPEED: Final = "right_wheel_speed"
...
ATTR_ROBOT_IN_MAP: Final = "robot_in_map"
ATTR_ROBOT_ICON: Final = "robot_icon"
ATTR_ROBOT_BEAM_ICON: Final = "robot_beam_icon"
...
ATTR_COLOR_PALETTE: Final = "color_palette"
ATTR_SEGMENT_MAP: Final = "segment_map"
ATTR_SEGMENT_ID: Final = "segment_id"
ATTR_ROOM_COLORS: Final = "room_colors"
...
ERROR_CODE_TO_ERROR_NAME: Final = {
    ...
    DreameVacuumErrorCode.LEFT_WHEEL_SPEED: ERROR_LEFT_WHEEL_SPEED,
    DreameVacuumErrorCode.RIGHT_WHEEL_SPEED: ERROR_RIGHT_WHEEL_SPEED,
...
ERROR_CODE_TO_IMAGE_INDEX: Final = {
    ...
    DreameVacuumErrorCode.LEFT_WHEEL_SPEED: 6,
    DreameVacuumErrorCode.RIGHT_WHEEL_SPEED: 6,
...
ERROR_CODE_TO_ERROR_DESCRIPTION: Final = {
    ...
    DreameVacuumErrorCode.LEFT_WHEEL_SPEED: [
        "Left wheel may be blocked by foreign objects",
        "Check whether there is any object stuck in the main wheels and start the robot in a new position.",
    ],
    DreameVacuumErrorCode.RIGHT_WHEEL_SPEED: [
