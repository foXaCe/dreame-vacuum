# Entities
<img src="https://raw.githubusercontent.com/foXaCe/dreame-vacuum/main/docs/media/entities.png">
...
| `error`   | Fault code description of robot | <a href="https://github.com/foXaCe/dreame-vacuum/blob/main/docs/notifications.md#error-reporting" target="_blank">Error reporting</a>
...
#### <a href="https://github.com/foXaCe/dreame-vacuum/blob/main/room_entities/map.md" target="_blank">For more info about customized cleaning feature</a>
...
- Saved map entities for multi-floor map entities uses indexing system instead of map id. <a href="https://github.com/foXaCe/dreame-vacuum/blob/main/docs/map.md#multi-floor-map-support" target="_blank">More info</a>
...
#### <a href="https://github.com/foXaCe/dreame-vacuum/blob/main/docs/map.md" target="_blank">For more info about map feature</a>
